      ...
      <main className="flex-grow pt-24">
        ...
        <div className="relative py-20 overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg max-w-2xl mx-auto animate-slide-up delay-200">
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="relative rounded-2xl overflow-hidden border border-black/[0.07] dark:border-white/[0.07] aspect-[4/3] bg-[var(--bg-elevated)]">
                <Image src="/team-photo.jpg" alt="Atlas Autoware Team" fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--bg-base)]/50 to-transparent" />
              </div>
              <div className="space-y-5">
                <p className="text-xs font-semibold text-red-600 dark:text-red-400 uppercase tracking-widest">Our Story</p>
                <h2
        ...
        <section className="py-20 bg-[var(--bg-surface)]">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center mb-10">
              <p className="text-xs font-semibold text-red-600 dark:text-red-400 uppercase tracking-widest mb-3">Our Origins</p>
              <h2
                className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-5"
                style={{ fontFamily: 'var(--font-space)' }}
              >
              ...
              {goals.map((g, i) => {
                ...
                return (
                  <div key={i} className="glass-card rounded-xl p-6 flex items-start gap-5">
                    ...
                    <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-sm">{g.text}</p>
                  </div>
                )
              })}
            </div>
        ...
        <section className="py-24">
          <div className="container mx-auto px-6 max-w-3xl">
            <p className="text-xs font-semibold text-red-600 dark:text-red-400 uppercase tracking-widest mb-3 text-center">FAQ</p>
            <h2
