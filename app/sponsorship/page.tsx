...
const tiers = [
  {
    ...
    amountColor: 'text-slate-600 dark:text-slate-200',
    featured: true,
    benefits: [
  ...
  },
  {
    ...
    amountColor: 'text-yellow-700 dark:text-yellow-300',
    featured: false,
    benefits: [
                ...
                >
                  {tier.featured && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                      <span className="text-xs font-semibold text-white bg-slate-500 dark:bg-slate-600 px-3 py-1 rounded-full">
                        Top Tier
                      </span>
                    </div>
                  )}
                  ...
                  <ul className="space-y-2.5 flex-1">
                    {tier.benefits.map((b, j) => (
                      <li key={j} className="flex items-start gap-2.5 text-sm text-slate-600 dark:text-slate-400">
                        <Check size={14} className="text-red-500 dark:text-red-400 mt-0.5 shrink-0" />
                        {b}
                      </li>
                    ))}
                  </ul>
        ...
        <section className="py-24">
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="mailto:contact@atlasautoware.org" className="btn-primary">Contact Us</a>
              <a
